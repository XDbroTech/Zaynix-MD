...
cmd(
    ...
    async (
        ...
        try {
            ...
            let desc = `*乂 Zaynix-MD SONG DOWNLOADER*
                ...
                from,
                {
                    ...
                    contextInfo: {
                        ...
                        externalAdReply: {
                            ...
                            body: `${data.title} : Powerd By Zaynix-MD Song Information Search Engine`,
...
cmd(
    ...
    async (
        ...
        try {
            ...
            let desc = `*乂 Zaynix-MD VIDEO DOWNLOADER*
            ...
            const sentMsg = await conn.sendMessage(
                from,
                {
                    ...
                    contextInfo: {
                        ...
                        externalAdReply: {
                            title: `Zaynix-MD Video Downloader`,
                            body: `${data.title} : Powerd By Zaynix-MD Song Information Search Engine`,
                            thumbnailUrl: data.thumbnail,
                            sourceUrl: ``,
                            mediaType: 1,
        ...
        try {
            ...
            if (response.status === "success ✅" && response.data) {
                ...
                if (hd || sd) {
                    ...
                    const videoMessage = `*乂 Zaynix-MD FB DOWNLOADER*
                        ...
                        from,
                        {
                            ...
                            contextInfo: {
                                ...
                                forwardedNewsletterMessageInfo: {
                                    ...
                                    externalAdReply: {
                                          title: `Zaynix-MD FB Downloader`,
                                          body: `Undifended : Powerd By Zaynix-MD FB Information Search Engine`,
...
cmd({
    ...
    try {
        ...
        // Watermark message
        let wm = `*乂 Zaynix-MD TIK TOK DOWNLOADER*
            ...
            from,
            {
                ...
                contextInfo: {
                    ...
                    forwardedNewsletterMessageInfo: {
                        ...
                        externalAdReply: {
                              title: `Zaynix-MD Tik Tok Downloader`,
                              body: `Undifended : Powerd By Zaynix-MD Tiktok Information Search Engine`,
...
cmd({
    ...
    const fileInfo = data.data || data;
                                                  ...
                                                  const downloadingMsg = await conn.sendMessage(
                                                      from,
                                                      {
                                                          text: `*乂 Zaynix-MD GDRIVE DOWNLOADER*
...
> *©ᴘᴏᴡᴇʀᴇᴅ ʙʏ ʀᴏᴍᴇᴋ-xᴅ*`,
                                                          contextInfo: {
                                                              ...
                                                              externalAdReply: {
                                                                  title: `Zaynix-MD Gdrive Downloader`,
                                                                  body: `${fileInfo.fileName || fileInfo.title || `Undifended`} : Powerd By Zaynix-MD Gdrive Information Search Engine`,
    ...
    try {
        ...
        const caption = `> *©ᴘᴏᴡᴇʀᴇᴅ ʙʏ ʀᴏᴍᴇᴋ-xᴅ*`;
        await conn.sendMessage(from, { 
    ...
    try {
        ...
        await conn.sendMessage(from, {
            image: { url: apkIcon },
                ...
                text: `*乂 Zaynix-MD APK DOWNLOADER*
...
> *©ᴘᴏᴡᴇʀᴇᴅ ʙʏ ʀᴏᴍᴇᴋ-xᴅ*`,
                contextInfo: {
                    ...
                    externalAdReply: {
                        title: `Zaynix-MD Application Downloader`,
                        body: `${apkName} : Powerd By Zaynix-MD Apk Information Search Engine`,
